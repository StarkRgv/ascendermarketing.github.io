...
export const workData = [
  {
    title: "Research",
    description:
      "Embark your journey towards a successful event with Ascender Marketing. Our seamless research process creates a strong foundation for all our upcoming events. Through comprehensive examination and consultation, we formulate the objectives, preferences, and requirements of our clients. Our attention to detail ensures that tailor each event in alignment with the unique needs of our clients.",
    img: "research.png",
    bg: "#3428C2",
  },
  {
    title: "Ideate",
    description:
      "Ascender Marketing will breathe life into your dreams through innovative ideas. All important information gathered during the research process is carefully translated into a detailed concept for the event in this phase.",
    img: "ideate.png",
    bg: "#92139B",
  },
  {
    title: "Exhibit",
    description:
      "In this phase, we will showcase our diligently prepared event concepts to you. Through visually stunning and clear communication, we will bring forward a comprehensible roadmap that will bring your vision to life.",
    img: "exhibit.png",
    bg: "#FF0059",
  },
  {
    title: "Design",
    description:
      "The creative prowess at Ascender Marketing will help elevate your event by profusing each element and detail of the event with innovation, creativity, and uniqueness catering to your needs. This experience will be lived through all stages from thematic designs and engaging experiences to leave a lasting impression on your guests.",
    img: "design.png",
    bg: "#11A2E5",
  },
  {
    title: "Execute",
    description:
      "Finally, your dream and vision will unfold into reality with Ascender Marketing. We promise seamless and expert execution by a team of professionals who work with precision, coordination, and attention to detail. All aspects of your event from logistics to management will be executed flawlessly in this stage leaving an impressionable experience for you and your attendees.",
    img: "execute.png",
    bg: "#F1522C",
  },
  {
...
export const serviceData = [
  ...
  },
  {
    name: "RETAIL",
    descrition:
      "Enhance your customer engagement, boost sales, and transform mere retail experiences into unforgettable brand interactions with Ascender Marketing. Our personalized services can help you drive foot traffic store openings, product showcases, and even in-store promotions.",
    images: [
      "Retail/retail1.JPG",
      "Retail/retail2.JPG",
      "Retail/retail3.JPG",
...
export const placeData = [
  ...
  },
  {
    ...
    address: {
      ...
      description:
        "Ascender Marketing Solutions Private Limited Pyramid Axis Office 302 Baner Road, Behind Croma Showroom Baner Pune, Maharashtra - 411045",
  ...
  // },
  {
    ...
    address: {
      description:
        "A-1,Raj industrial complex Marol militry road marol Andheri East Mumbai, Mumbai, Maharashtra - 400059",
    },
  },
  {
    name: "Dubai",
  ...
  },
  {
    ...
    address: {
      description:
        "39/135 Moo 10, Soi Khao Noi Sub District Nong Prue Bang Lamung District Chonburi -20150 Thailand ",
    },
  },
];
